...
class DeveloperPreview{
    ...
    let restaurant = Restaurant(id: UUID().uuidString,
                                ...
                                address: Address(city: "Almaty",
                                                 address: "9613 Bellevue St.Athens, GA 30605",
                                                 latitude: 41.8902,
                                                 longitude: 12.4922),
                                image: "restaurant1",
                                rating: 4.8,
    ...
    let restaurants = [
        ...
        Restaurant(id: UUID().uuidString,
                   name: "Bulgari Hotel",
                   address: Address(city: "Almaty",
                                    address: "940 N. Delaware Road Uniondale, NY 11553",
                                    latitude: 41.9009,
                                    longitude: 12.4833),
                   image: "restaurant2",
                   rating: 3.7,
        ...
        Restaurant(id: UUID().uuidString,
                   ...
                   address: Address(city: "Almaty",
                                    address: "4 West Alton Avenue Torrance, CA 90505",
                                    latitude: 48.8584,
                                    longitude: 2.2945),
                   image: "restaurant3",
                   rating: 4.7,
        ...
        Restaurant(id: UUID().uuidString,
                   ...
                   address: Address(city: "Almaty",
                                    address: "62 Shadow Brook Lane Fenton, MI 48430",
                                    latitude: 48.8606,
                                    longitude: 2.3376),
                   image: "restaurant4",
                   rating: 2.7,
        ...
        Restaurant(id: UUID().uuidString,
                   name: "London, UK",
                   address: Address(city: "Almaty",
                                    address: "20 Bridgeton St.Thibodaux, LA 70301",
                                    latitude: 44.8606,
                                    longitude: 1.3376),
                   image: "restaurant6",
                   rating: 4.1,
    ...
    let ongoingRestaurants = [
        ReservedRestaurant(id: UUID().uuidString,
                   name: "Palazzo Hotel",
                   address: Address(city: "Almaty",
                                    address: "9613 Bellevue St.Athens, GA 30605",
                                    latitude: 41.8986,
